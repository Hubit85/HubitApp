...
export const translations = {
    en: {
        ...
        personalContactInfo: "Personal and contact information",
        configurePassword: "Configure your password",
        ...
        commercialPhone: "Business phone",
        verifyingCIF: "Verifying Tax ID...",
        cifValid: "Valid Tax ID",
        cifInvalid: "Invalid Tax ID",
        professionalNumber: "Professional license number",
        ...
        nextRole: "Next role",
        configurePasswordBtn: "Configure password",
        ...
        byCreatingAccount: "By creating an account, you accept our",
        termsOfService: "Terms of Service",
        and: "and",
        privacyPolicy: "Privacy Policy",
        mustSelectRole: "You must select at least one role to continue",
        completingAccountCreation: "Completing account creation...",
        accountCreatedSuccessfully: "Account created successfully!",
        pleaseCompleteAllFields: "Please complete all required fields for this role.",
        registrationCommunityCode: "Community code (optional)",
        ifYouKnowCode: "If you know your community's code",
        ifNoCode: "If you don't have a code, one will be generated automatically",
        step: "Step {{current}} of {{total}}",
        registrationParticular: "Individual",
        individualHomeowner: "Individual homeowner",
        registrationCommunityMember: "Community Member",
        ownerInCommunity: "Owner in a community of neighbors",
        registrationServiceProvider: "Service Provider",
        companyOfferingServices: "Company offering professional services",
        propertyAdministrator: "Property Administrator",
        professionalCommunityManagement: "Professional community management",
        fullAddress: "Full address",
        communityAddress: "Community address",
        fullCommunityAddress: "Full community address",
    ...
    es: {
        ...
        personalContactInfo: "Información personal y de contacto",
        configurePassword: "Configura tu contraseña",
        chooseSecurePassword: "Elige una contraseña segura",
        verifyingSession: "Verificando sesión...",
        progressComplete: "Progreso: {{progress}}% completado",
        rolesSelected: "Roles seleccionados:",
        continue: "Continuar",
        registrationCompanyName: "Nombre de la empresa",
        cif: "CIF",
        companyAddress: "Dirección de la empresa",
        registrationPostalCode: "Código postal",
        registrationCity: "Ciudad",
        registrationProvince: "Provincia",
        ...
        commercialPhone: "Teléfono comercial",
        verifyingCIF: "Verificando CIF...",
        cifValid: "CIF válido",
        cifInvalid: "CIF no válido",
        professionalNumber: "Número de colegiado",
        servicesOffered: "Servicios que ofreces",
        totalMonthlyCost: "Coste total mensual",
        servicesSelected: "Servicios seleccionados",
        previousRole: "Rol anterior",
        selectRoles: "Seleccionar roles",
        nextRole: "Siguiente rol",
        configurePasswordBtn: "Configurar contraseña",
        registrationConfirmPassword: "Confirmar contraseña",
        passwordMustContain: "Tu contraseña debe contener:",
        ...
        registrationLogin: "Iniciar sesión",
        byCreatingAccount: "Al crear una cuenta, aceptas nuestros",
        termsOfService: "Términos de Servicio",
        and: "y",
        privacyPolicy: "Política de Privacidad",
        mustSelectRole: "Debes seleccionar al menos un rol para continuar",
        completingAccountCreation: "Completando creación de cuenta...",
        accountCreatedSuccessfully: "¡Cuenta creada exitosamente!",
        pleaseCompleteAllFields: "Por favor, completa todos los campos requeridos para este rol.",
        registrationCommunityCode: "Código de comunidad (opcional)",
        ifYouKnowCode: "Si conoces el código de tu comunidad",
        ifNoCode: "Si no tienes código, se generará uno automáticamente",
        step: "Paso {{current}} de {{total}}",
        registrationParticular: "Particular",
        individualHomeowner: "Propietario individual de vivienda",
        registrationCommunityMember: "Miembro de Comunidad",
        ownerInCommunity: "Propietario en una comunidad de vecinos",
        registrationServiceProvider: "Proveedor de Servicios",
        companyOfferingServices: "Empresa que ofrece servicios profesionales",
        propertyAdministrator: "Administrador de Fincas",
        professionalCommunityManagement: "Gestión profesional de comunidades",
        fullAddress: "Dirección completa",
        communityAddress: "Dirección de la comunidad",
        fullCommunityAddress: "Dirección completa de la comunidad",
