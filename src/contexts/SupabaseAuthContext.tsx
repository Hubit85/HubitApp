    ...
    try {
      ...
      try {
        ...
        if (roles.length === 0) {
          ...
          // Single-role accounts must remain single-role unless the user explicitly adds roles.
          console.log('✅ CRITICAL: Single role detected; skipping automatic role expansion.');

          // Continue with normal single-role processing
