...
const translations = {
  en: {
    ...
    exampleLeakRepair: "Example: Kitchen faucet leak repair",
    detailedDescription: "Detailed Description",
    describeServiceNeeded: "Describe the service needed in detail...",
    requestQuotes: "Request Quotes",
    searchProviders: "Search providers...",
    reviews: "reviews",
    loadMoreProviders: "Load More Providers",
    noFavoriteProviders: "No favorite providers",
    addFavoriteProvidersDesc: "Start adding your favorite service providers to access them quickly",
    exploreProviders: "Explore Providers",
    apartmentInCenter: "Apartment in Center",
    beachHouse: "Beach House",
    loungePainting: "Lounge Painting",
    noServiceHistoryMessage: "Start requesting services to build your history",
    ...
    basedOnHistory: "Based on your service history",
