...
const translations = {
  en: {
    ...
    // Whitepaper
    whitepaperTitle: "HuBiT Whitepaper",
    whitepaperSubtitle: "Decentralized Property Management on Solana",
    executiveSummary: "Executive Summary",
    executiveSummaryText: "HuBiT is a utility token built on Solana that connects property managers, service providers, and residents in a transparent ecosystem. By holding HuBiT, users access premium features, while the token funds platform growth without intermediaries.",
    whySolana: "Why Solana?",
    lowFees: "Low fees per transaction",
    highSpeed: "TPS High speed",
    massAdoption: "Mass adoption ready",
    ...
    publicCirculation: "Public Circulation",
    utility: "Utility",
    holdHubit: "Hold 100 HuBiT:",
    holdHubitDesc: "Ad-free app, voting rights, premium features",
    payAsYouGo: "Pay-as-you-go:",
    payAsYouGoDesc: "€1.99/month for non-holders",
    staking: "Staking:",
    stakingDesc: "Earn rewards for locking tokens (future phase)",
    roadmap: "Roadmap",
    q3Title: "Q3 2025",
    mvpDevelopment: "MVP Development:",
    mvpDevelopmentDesc: "Demo of HuBiT app",
    brandLaunch: "Brand Launch:",
    brandLaunchDesc: "Website + Twitter",
    tokenDeployment: "Token Deployment:",
    tokenDeploymentDesc: "SPL token creation on Solana",
    q4Title: "Q4 2025",
    appBetaRelease: "App Beta Release:",
    appBetaReleaseDesc: "iOS/Android (property management features, Solana wallet integration)",
    listings: "Listings:",
    listingsDesc: "CoinMarketCap, CoinGecko, centralized and decentralized exchanges",
    partnerships: "Partnerships:",
    partnershipsDesc: "50+ service providers onboarded",
    q1Title: "Q1 2026",
    globalExpansion: "Global Expansion:",
    globalExpansionDesc: "International market campaigns",
  ...
  es: {
    ...
    tenThousandUsers: "10,000+ Usuarios:",
    tenThousandUsersDesc: "Incentivados a través de airdrops y recompensas comunitarias",
    governanceDao: "DAO de Gobernanza:",
    governanceDaoDesc: "Los poseedores de tokens votan sobre mejoras de la plataforma",
    joinCommunity: "Únete a nuestra comunidad y sé parte del futuro de la gestión de propiedades",
