...
const baseTranslations = {
  es: {
    ...
    whoWeAreSubtitle: "Conectando comunidades con servicios profesionales de calidad",
    ourMission: "Nuestra Misión",
    ourMissionText: "En HANDYMAN, nos dedicamos a transformar la manera en que las comunidades residenciales acceden a servicios profesionales. Creemos que cada hogar merece atención de calidad, y trabajamos para conectar a residentes, administradores de fincas y proveedores de servicios en una plataforma integral y confiable.",
    ourVision: "Nuestra Visión",
    ourVisionText: "Ser la plataforma líder en España para servicios residenciales, creando un ecosistema donde la calidad, la confianza y la eficiencia se encuentran para mejorar la vida en las comunidades.",
    ourValues: "Nuestros Valores",
    qualityFirst: "Calidad Primero",
    qualityFirstText: "Trabajamos únicamente con profesionales verificados y certificados que cumplen con nuestros altos estándares de calidad.",
    transparency: "Transparencia",
    transparencyText: "Creemos en la comunicación clara y honesta en todas nuestras interacciones, desde presupuestos hasta la finalización de proyectos.",
    reliability: "Confiabilidad",
    reliabilityText: "Nuestros usuarios pueden confiar en que cumpliremos nuestras promesas y estaremos disponibles cuando nos necesiten.",
    innovation: "Innovación",
    innovationText: "Utilizamos la tecnología más avanzada para simplificar procesos y mejorar la experiencia de todos nuestros usuarios.",
    whatMakesUsDifferent: "¿Qué nos hace diferentes?",
    verifiedProfessionals: "Profesionales Verificados",
    verifiedProfessionalsText: "Todos nuestros proveedores de servicios pasan por un riguroso proceso de verificación que incluye revisión de credenciales, seguros y referencias.",
    communityFocused: "Enfoque Comunitario",
    communityFocusedText: "Entendemos las necesidades específicas de las comunidades residenciales y ofrecemos soluciones adaptadas a cada tipo de propiedad.",
    digitalPlatform: "Plataforma Digital Integral",
    digitalPlatformText: "Desde la solicitud de servicios hasta el seguimiento de proyectos, todo se gestiona a través de nuestra plataforma fácil de usar.",
    support247: "Soporte 24/7",
    support247Text: "Nuestro equipo de atención al cliente está disponible las 24 horas para resolver cualquier duda o problema que puedas tener.",
    ourTeam: "Nuestro Equipo",
    ourTeamText: "Contamos con un equipo multidisciplinario de expertos en tecnología, servicios residenciales y atención al cliente, todos comprometidos con brindar la mejor experiencia posible.",
  ...
  en: {
    ...
    whoWeAreSubtitle: "Connecting communities with quality professional services",
    ourMission: "Our Mission",
    ourMissionText: "At HANDYMAN, we are dedicated to transforming the way residential communities access professional services. We believe that every home deserves quality attention, and we work to connect residents, property managers, and service providers on a comprehensive and reliable platform.",
    ourVision: "Our Vision",
    ourVisionText: "To be the leading platform in Spain for residential services, creating an ecosystem where quality, trust, and efficiency come together to improve life in communities.",
    ourValues: "Our Values",
    qualityFirst: "Quality First",
    qualityFirstText: "We work exclusively with verified and certified professionals who meet our high quality standards.",
    transparency: "Transparency",
    transparencyText: "We believe in clear and honest communication in all our interactions, from quotes to project completion.",
    reliability: "Reliability",
    reliabilityText: "Our users can trust that we will keep our promises and be available when they need us.",
    innovation: "Innovation",
    innovationText: "We use the most advanced technology to simplify processes and improve the experience for all our users.",
    whatMakesUsDifferent: "What makes us different?",
    verifiedProfessionals: "Verified Professionals",
    verifiedProfessionalsText: "All our service providers go through a rigorous verification process that includes credential review, insurance, and references.",
    communityFocused: "Community Focused",
    communityFocusedText: "We understand the specific needs of residential communities and offer solutions tailored to each type of property.",
    digitalPlatform: "Comprehensive Digital Platform",
    digitalPlatformText: "From service requests to project tracking, everything is managed through our easy-to-use platform.",
    support247: "24/7 Support",
    support247Text: "Our customer service team is available 24 hours a day to resolve any questions or problems you may have.",
    ourTeam: "Our Team",
    ourTeamText: "We have a multidisciplinary team of experts in technology, residential services, and customer service, all committed to providing the best possible experience.",
