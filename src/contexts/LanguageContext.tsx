...
const translations = {
  en: {
    ...
    hbitBenefits: "Benefits of using the platform while holding HBIT",
    benefit1: "Airdrops",
  ...
  es: {
    ...
    hbitBenefits: "Beneficios de usar la plataforma manteniendo HBIT",
    benefit1: "Lanzamientos Aéreos",
    benefit2: "Acceso a todas las funcionalidades",
    benefit3: "Publicidad de tu empresa",
    benefit4: "Recompensas por Fidelidad",
