...
const translations = {
  es: {
    ...
    whoWeAreDesc1: "Somos una plataforma que conecta a profesionales cualificados con personas que necesitan servicios para el hogar.",
    whoWeAreDesc2: "Nuestro objetivo es facilitar la contratación de servicios de calidad de manera rápida y segura.",
  ...
  en: {
    ...
    whoWeAre: "Who we are",
    whoWeAreDesc1: "We are a platform that connects qualified professionals with people who need home services.",
    whoWeAreDesc2: "Our goal is to facilitate the hiring of quality services quickly and safely.",
  ...
  fr: {
    ...
    whoWeAreDesc1: "Nous sommes une plateforme qui met en relation des professionnels qualifiés avec des personnes qui ont besoin de services à domicile.",
    whoWeAreDesc2: "Notre objectif est de faciliter l'embauche de services de qualité rapidement et en toute sécurité.",
  ...
  ru: {
    ...
    whoWeAre: "Кто мы",
    whoWeAreDesc1: "Мы платформа, которая связывает квалифицированных специалистов с людьми, которым нужны домашние услуги.",
    whoWeAreDesc2: "Наша цель - облегчить наем качественных услуг быстро и безопасно.",
  ...
  zh: {
    ...
    whoWeAre: "我们是谁",
    whoWeAreDesc1: "我们是一个将合格专业人员与需要家庭服务的人联系起来的平台。",
    whoWeAreDesc2: "我们的目标是快速安全地促进优质服务的雇用。",
    howItWorks: "如何运作",
