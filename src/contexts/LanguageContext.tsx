...
const translations = {
  en: {
    ...
    redirectredirectToServiceDashboard: "Redirectredirect to Service Dashboard",
  ...
  es: {
    ...
    redirectredirectToServiceDashboard: "Redirigiendo al panel de servicios",
    ...
    viewFullRating: "Ver valoración completa",
    notRatedYet: "Aún no valorado",
    waitingForCustomerRating: "Esperando valoración del cliente",
    contactCustomer: "Contactar Cliente",
    totalServicesProvided: "Servicios totales proporcionados",
    averageCustomerRating: "Valoración promedio de clientes",
    ...
    filterByCustomerType: "Filtrar por Tipo de Cliente",
    allCustomerTypes: "Todos los Tipos",
    particularCustomers: "Clientes Particulares",
    communityCustomers: "Clientes Comunitarios",
    providerServiceHistory: "Mi Historial de Servicios",
    servicesProvidedTo: "Servicios proporcionados a",
    ...
    loungePainting: "Pintura de Salón",
    generalCleaning: "Limpieza General",
    excellentServiceComment: "Excelente servicio, muy profesional y rápido",
    goodWorkComment: "Buen trabajo, aunque tardó un poco más de lo esperado",
    emergencyRepairs: "Reparaciones de emergencia",
    newInstallations: "Instalaciones nuevas",
    maintenanceSpec: "Mantenimiento",
    interiorPaintingSpec: "Pintura interior",
    exteriorPaintingSpec: "Pintura exterior",
    decorativePaintingSpec: "Decorativa",
