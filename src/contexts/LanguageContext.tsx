...
const baseTranslations = {
  ...
  en: {
    ...
    dashboardText: "Access your dashboard to manage services, view requests and administer your professional profile.",
    openDashboard: "Open Dashboard",
    serviceProfile: "Service Profile",
    manageOfferings: "Manage your offerings",
    serviceProfileText: "Configure and manage your service profile to showcase your experience and specialties.",
    ...
    // All service-specific translations in English
    ...
    // Add all other English translations for completeness
    masonry: "Masonry",
    roofing: "Roofing",
    ...
    // Add all remaining translations to match Spanish version
...
export default function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const t = useCallback((key: string, langOverride?: Language): string => {
    ...
    const translation = baseTranslations[currentLang]?.[key as keyof typeof baseTranslations[typeof currentLang]];
