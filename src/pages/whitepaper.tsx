                    ...
                    <div className="relative h-80 bg-gradient-to-t from-neutral-50/30 to-transparent">
                      ...
                      <div className="absolute inset-0 flex items-end justify-between px-2">
                        ...
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '272px' }}>
                            ...
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '240px', height: '16px' }}>
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-12 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700 bg-white px-2 py-1 rounded shadow-lg border">850M</div>
                            </div>
                          ...
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-blue-50 px-2 py-1 rounded-md whitespace-nowrap">Q4 2025</div>
                        </div>

                        {/* Q1 2026: 925M (600M Pool + 150M Equipo + 75M Marketing + 75M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '296px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            ...
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '264px', height: '24px' }}>
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-12 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700 bg-white px-2 py-1 rounded shadow-lg border">925M</div>
                            </div>
                            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700">925M</div>
                          </div>
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q1 2026</div>
                        </div>

                        {/* Q2 2026: 962.5M (600M Pool + 175M Equipo + 87.5M Marketing + 87.5M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '308px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            ...
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '276px', height: '28px' }}>
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-12 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700 bg-white px-2 py-1 rounded shadow-lg border">962M</div>
                            </div>
                            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700">962M</div>
                          </div>
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q2 2026</div>
                        </div>

                        {/* Q3 2026: 981.25M (600M Pool + 187.5M Equipo + 93.75M Marketing + 93.75M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '314px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            ...
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '282px', height: '30px' }}>
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-12 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700 bg-white px-2 py-1 rounded shadow-lg border">981M</div>
                            </div>
                            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700">981M</div>
                          </div>
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q3 2026</div>
                        </div>

                        {/* Q4 2026: 990.625M (600M Pool + 193.75M Equipo + 96.875M Marketing + 96.875M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '317px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            ...
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '285px', height: '31px' }}>
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-12 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700 bg-white px-2 py-1 rounded shadow-lg border">990M</div>
                            </div>
                            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700">990M</div>
                          </div>
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q4 2026</div>
                        </div>

                        {/* Q1 2027: 995.31M (600M Pool + 196.875M Equipo + 98.44M Marketing + 98.44M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '318px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            ...
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '286px', height: '31px' }}>
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-12 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700 bg-white px-2 py-1 rounded shadow-lg border">995M</div>
                            </div>
                            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700">995M</div>
                          </div>
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q1 2027</div>
                        </div>

                        {/* Q2 2027: 997.66M (600M Pool + 198.44M Equipo + 99.22M Marketing + 99.22M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '319px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            ...
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '288px', height: '32px' }}>
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-12 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700 bg-white px-2 py-1 rounded shadow-lg border">997M</div>
                            </div>
                            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700">997M</div>
                          </div>
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q2 2027</div>
                        </div>

                        {/* Q3 2027: 998.83M (600M Pool + 199.22M Equipo + 99.61M Marketing + 99.61M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '319.5px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-red-500 to-red-400" style={{ bottom: '192px', height: '64px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-yellow-500 to-yellow-400" style={{ bottom: '256px', height: '32px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '288px', height: '32px' }}>
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-12 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700 bg-white px-2 py-1 rounded shadow-lg border">998M</div>
                            </div>
                            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700">998M</div>
                          </div>
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q3 2027</div>
                        </div>

                        {/* Q4 2027: 999.41M (600M Pool + 199.61M Equipo + 99.805M Marketing + 99.805M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '319.8px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-red-500 to-red-400" style={{ bottom: '192px', height: '64px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-yellow-500 to-yellow-400" style={{ bottom: '256px', height: '32px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '288px', height: '32px' }}>
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-12 left-1/2 transform -translate-x-1/2 text-xs font-bold text-emerald-600 bg-white px-2 py-1 rounded shadow-lg border">999M</div>
                            </div>
                            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700">999M</div>
                          </div>
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q4 2027</div>
                        </div>

                        {/* Q1 2028: 999.705M (600M Pool + 199.805M Equipo + 99.9025M Marketing + 99.9025M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '319.9px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-red-500 to-red-400" style={{ bottom: '192px', height: '64px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-yellow-500 to-yellow-400" style={{ bottom: '256px', height: '32px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '288px', height: '32px' }}>
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-12 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700 bg-white px-2 py-1 rounded shadow-lg border">999M</div>
                            </div>
                            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-700">999M</div>
                          </div>
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q1 2028</div>
                        </div>

                        {/* Siguientes trimestres hasta Q4 2029 aproximándose a 1000M */}
                        {/* Q2 2028: 999.85M */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '319.95px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-red-500 to-red-400" style={{ bottom: '192px', height: '64px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-yellow-500 to-yellow-400" style={{ bottom: '256px', height: '32px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '288px', height: '32px' }}>
                          ...
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q2 2028</div>
                        </div>

                        {/* Q3 2028: 999.92M */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '319.97px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-red-500 to-red-400" style={{ bottom: '192px', height: '64px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-yellow-500 to-yellow-400" style={{ bottom: '256px', height: '32px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '288px', height: '32px' }}>
                          ...
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q3 2028</div>
                        </div>

                        {/* Q4 2028: 999.96M */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '319.99px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-red-500 to-red-400" style={{ bottom: '192px', height: '64px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-yellow-500 to-yellow-400" style={{ bottom: '256px', height: '32px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '288px', height: '32px' }}>
                          ...
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q4 2028</div>
                        </div>
                        ...
                        <div className="group flex flex-col items-center flex-1 relative">
                          ...
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q1 2029</div>
                        </div>

                        {/* Q2 2029: 999.99M */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '319.995px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-red-500 to-red-400" style={{ bottom: '192px', height: '64px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-yellow-500 to-yellow-400" style={{ bottom: '256px', height: '32px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '288px', height: '32px' }}>
                          ...
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q2 2029</div>
                        </div>

                        {/* Q3 2029: 999.995M */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '319.998px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-red-500 to-red-400" style={{ bottom: '192px', height: '64px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-yellow-500 to-yellow-400" style={{ bottom: '256px', height: '32px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '288px', height: '32px' }}>
                          ...
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q3 2029</div>
                        </div>

                        {/* Q4 2029: 1000M (VESTING COMPLETO - 600M Pool + 200M Equipo + 100M Marketing + 100M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="relative w-4 bg-neutral-100 rounded-t-lg shadow-lg border border-neutral-200/60" style={{ height: '320px' }}>
                            <div className="absolute bottom-0 w-full bg-gradient-to-t from-blue-500 to-blue-400" style={{ height: '192px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-red-500 to-red-400" style={{ bottom: '192px', height: '64px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-yellow-500 to-yellow-400" style={{ bottom: '256px', height: '32px' }}></div>
                            <div className="absolute w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg" style={{ bottom: '288px', height: '32px' }}>
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-12 left-1/2 transform -translate-x-1/2 text-xs font-bold text-emerald-600 bg-white px-2 py-1 rounded shadow-lg border">1,000M</div>
                            </div>
                            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 text-xs font-bold text-emerald-600">1,000M</div>
                          </div>
                          <div className="opacity-0 group-hover:opacity-100 transition-opacity mt-4 text-xs font-semibold text-neutral-600 bg-emerald-50 px-2 py-1 rounded-md whitespace-nowrap">Q4 2029</div>
                        </div>
                      </div>
                    </div>
                  </div>
