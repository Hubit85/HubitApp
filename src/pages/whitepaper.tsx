                  ...
                  <div className="ml-16 mr-8 pt-8">
                    ...
                    <div className="relative h-80 bg-gradient-to-t from-neutral-50/30 to-transparent">
                      ...
                      <div className="absolute inset-0 flex items-end justify-between px-2">
                        ...
                        {/* Q1 2026: 900M (600M Pool + 150M Equipo + 75M Marketing + 75M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-800 bg-white/90 px-2 py-1 rounded shadow">
                            900M
                          </div>
                        ...
                        {/* Q2 2026: 950M (600M Pool + 175M Equipo + 87.5M Marketing + 87.5M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-800 bg-white/90 px-2 py-1 rounded shadow">
                            950M
                          </div>
                        ...
                        {/* Q3 2026: 975M (600M Pool + 187.5M Equipo + 93.75M Marketing + 93.75M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-800 bg-white/90 px-2 py-1 rounded shadow">
                            975M
                          </div>
                        ...
                        {/* Q4 2026: 987.5M (600M Pool + 193.75M Equipo + 96.875M Marketing + 96.875M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-800 bg-white/90 px-2 py-1 rounded shadow">
                            987M
                          </div>
                        ...
                        {/* Q1 2027: 993.75M (600M Pool + 196.875M Equipo + 98.44M Marketing + 98.44M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-800 bg-white/90 px-2 py-1 rounded shadow">
                            993M
                          </div>
                        ...
                        {/* Q2 2027: 996.875M (600M Pool + 198.44M Equipo + 99.22M Marketing + 99.22M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-800 bg-white/90 px-2 py-1 rounded shadow">
                            996M
                          </div>
                        ...
                        {/* Q3 2027: 998.44M (600M Pool + 199.22M Equipo + 99.61M Marketing + 99.61M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-800 bg-white/90 px-2 py-1 rounded shadow">
                            998M
                          </div>
                        ...
                        {/* Q4 2027: 999.22M (600M Pool + 199.61M Equipo + 99.805M Marketing + 99.805M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-800 bg-white/90 px-2 py-1 rounded shadow">
                            999M
                          </div>
                        ...
                        {/* 2028: 999.8M PROMEDIO (600M Pool + 199.9M Equipo + 99.95M Marketing + 99.95M Airdrops) */}
                        <div className="group flex flex-col items-center flex-1 relative">
                          <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 text-xs font-bold text-neutral-800 bg-white/90 px-2 py-1 rounded shadow">
                            999.8M
                          </div>
