...
function RegisterPageContent() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Only create roles explicitly selected by the user during registration.
            console.log('👤 REGISTRATION: Preparing explicitly selected roles...');
            ...
            if (result?.success) {
                ...
                if (finalAdditionalRoles.length > 0) {
                    registrationSummary += ` Se configuraron ${finalAdditionalRoles.length} rol(es) adicional(es) seleccionado(s).`;
                }
