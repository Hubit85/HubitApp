          ...
          <div className="container mx-auto px-4 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              ...
              >
                <Card 
                  className={`shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group ${
                    expandedCard === 'communityMember' ? 'md:col-span-2 bg-green-50' : 'hover:bg-green-50'
                  }`}
                      ...
                      <CardContent className="pt-0">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-green-800">{t('features')}</h3>
                          ...
                          <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-green-800">{t('recentActivity')}</h3>
              ...
              >
                <Card 
                  className={`shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group ${
                    expandedCard === 'serviceProvider' ? 'md:col-span-2 bg-blue-50' : 'hover:bg-blue-50'
                  }`}
                  ...
                  {expandedCard === 'serviceProvider' && (
                    ...
                    >
                      <CardContent className="pt-0">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-blue-800">{t('services')}</h3>
                            <ul className="space-y-2 text-gray-600">
                              <li className="flex items-center gap-2">
                          ...
                          <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-blue-800">{t('statistics')}</h3>
                            <div className="space-y-3">
                              <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm">
                                <Star className="h-4 w-4 text-blue-500" />
                                <div>
              ...
              >
                <Card 
                  className={`shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group ${
                    expandedCard === 'estateAdministrator' ? 'md:col-span-2 bg-purple-50' : 'hover:bg-purple-50'
                  }`}
                  onClick={() => handleCardExpand('estateAdministrator')}
                >
                  <CardHeader className="text-center">
                    <div className="mx-auto w-20 h-20 bg-purple-100 rounded-full flex items-center justify-center mb-4 group-hover:bg-purple-200 transition-colors">
                  ...
                  {expandedCard === 'estateAdministrator' && (
                    ...
                    >
                      <CardContent className="pt-0">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-purple-800">{t('management')}</h3>
                            <ul className="space-y-2 text-gray-600">
                              <li className="flex items-center gap-2">
                          ...
                          <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-purple-800">{t('portfolio')}</h3>
                            <div className="space-y-3">
                              <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm">
              ...
              >
                <Card 
                  className={`shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group ${
                    expandedCard === 'particular' ? 'md:col-span-2 bg-orange-50' : 'hover:bg-orange-50'
                  }`}
                  ...
                  {expandedCard === 'particular' && (
                    ...
                    >
                      <CardContent className="pt-0">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-orange-800">{t('services')}</h3>
                            <ul className="space-y-2 text-gray-600">
                              <li className="flex items-center gap-2">
                          ...
                          <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-orange-800">{t('quickAccess')}</h3>
                            <div className="space-y-3">
                              <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm">
